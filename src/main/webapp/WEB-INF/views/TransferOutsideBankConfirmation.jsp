...
<head>
<meta charset="UTF-8">
<title>Transfer Outside Bank Confirmation</title>
</head>
<style>
    body
    {
...
<h2 align="center">Fund Transfer Outside bank Successful.</h2> 
 <div id="wrapper">
<hr/>
...
--%>
<h3> Your fund has been transfered to intended account.  </h3>

<h4> Beneficiary Name: ${paymentsAndFundTransfer.getPayee()} </h4>
<h4> Amount : ${paymentsAndFundTransfer.getAmount()} </h4>

<h4> Payment mode: ${paymentsAndFundTransfer.getTransferType()} </h4>
